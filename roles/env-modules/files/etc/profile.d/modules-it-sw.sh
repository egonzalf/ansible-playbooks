...
MODULEPATH=$MODULEPATH:$SPACK_MODULES_ROOT/linux-ubuntu16.04-x86_64:$KAUST_MODULES_ROOT/applications:$KAUST_MODULES_ROOT/compilers:$KAUST_MODULES_ROOT/sets
export MODULEPATH
